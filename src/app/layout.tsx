...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "CarShare - Transform Your Urban Commute",
    description: "Access premium vehicles instantly with comprehensive insurance and flexible pricing. Join thousands of smart commuters.",
    url: "https://carshare.com",
    siteName: "CarShare",
    images: [
      {
        url: "/placeholders/placeholder1.webp",
        alt: "CarShare vehicles ready for booking"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "CarShare - Smart Urban Mobility Platform",
    description: "Transform your commute with instant access to premium vehicles. No ownership hassles, just pure convenience.",
